-- Static initialization for shared database metadata and business tables.
-- Keep this in sync with API/JavaAPI/src/main/resources/dbmigrate/V1__CreateTables.sql.
